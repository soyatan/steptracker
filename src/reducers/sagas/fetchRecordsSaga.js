...
import { addError, setUserToken, SIGNUP_REQUEST, SIGNIN_REQUEST, SIGNOUT_REQUEST, signOutCurrentUser, userReducer, userSelector } from '../userReducer';
import AsyncStorage from '@react-native-async-storage/async-storage';
import {  CREATE_RECORD_REQUEST, FETCH_RECORDS, setRecords } from '../recordReducer';
...
export const fetchRecordsSaga=[

    fork(watchFetchRecordsRequest),
