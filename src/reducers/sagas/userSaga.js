...
import { addError, setUserToken, SIGNUP_REQUEST, SIGNIN_REQUEST, SIGNOUT_REQUEST, signOutCurrentUser } from '../userReducer';
...
function* signInRequest (action) {
    ...
    yield put(addError('Something went wrong with signing in, please try again'))
 }
}
